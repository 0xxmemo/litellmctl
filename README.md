...
| ------------------- | ------------------------ | ---------------------------- | --------------------------- | ----------------------------------- | ------------------- |
| `claude-opus-4-6`   | `qwen/qwen3-coder-plus`  | `dashscope/qwen3-max`        | `codex/gpt-5.3-codex`       | `gemini-cli/gemini-3-pro-preview`   | `zai/glm-5`         |
...
(e.g. `qwen/qwen3-coder-plus`, `dashscope/qwen3-max`, `codex/gpt-5.3-codex`, `gemini-cli/gemini-2.5-pro`, `zai/glm-5`).
...
| **DashScope**   | API key (Coding Plan)    | `dashscope/qwen3-max`, `dashscope/qwen3-coder-plus`                                                                                                                     |
