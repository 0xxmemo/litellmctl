...
import { COLLECTION_LIMIT_MESSAGE } from "./core/vectordb/types";
import { SnapshotManager } from "./snapshot";
import { ensureAbsolutePath, truncateContent, trackCodebasePath } from "./utils";
...
export class ToolHandlers {
    ...
    private async startBackgroundIndexing(codebasePath: string, forceReindex: boolean, splitterType: string) {
        ...
        try {
            ...
            const { FileSynchronizer } = await import("./core/sync/synchronizer");
